...
class DetilTransaksiProdukModel extends CI_Model{
    ...
    public function getall($id_trans){
        if($id_trans==null){
            $this->db->select('DETIL_TRANSAKSI_PRODUK.ID_DETIL_TRANSAKSI,DETIL_TRANSAKSI_PRODUK.ID_TRANSAKSI_PRODUK,DETIL_TRANSAKSI_PRODUK.ID_PRODUK, PRODUK.NAMA_PRODUK,DETIL_TRANSAKSI_PRODUK.SUB_TOTAL_PRODUK,DETIL_TRANSAKSI_PRODUK.JUMLAH_PRODUK')
